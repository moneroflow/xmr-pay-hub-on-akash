/**
 * BIP-39 English Wordlist (1626 words)
...
export const BIP39_ENGLISH_WORDLIST = [
  ...
  'corner', 'correct', 'cost', 'cotton', 'couch', 'country', 'couple', 'course',
  ...
  'edge', 'edit', 'educate', 'effort', 'egg', 'eight', 'elbow', 'elder',
  ...
  'journey', 'joy', 'judge', 'juggle', 'juice', 'jump', 'jungle', 'junior',
  'junk', 'just', 'kangaroo', 'keen', 'keep', 'ketchup', 'key', 'kick', 'kid',
  ...
  'off', 'offer', 'office', 'often', 'oil', 'okay', 'old', 'olive', 'olympic',
  'omit', 'once', 'one', 'onion', 'online', 'only', 'open', 'opera', 'opinion',
  'oppose', 'option', 'orange', 'orchard', 'order', 'ordinary', 'organ', 'orient',
  ...
  'project', 'promote', 'proof', 'property', 'prosper', 'protect', 'proud',
  ...
  'rapid', 'rare', 'rate', 'rather', 'raven', 'raw', 'read', 'real', 'realm',
  'reason', 'rebel', 'rebuild', 'receipt', 'receive', 'recipe', 'record', 'recycle',
  ...
  'replace', 'reply', 'report', 'represent', 'repress', 'reputation', 'require',
  ...
  'simple', 'since', 'sing', 'siren', 'sister', 'sit', 'situation', 'six',
  ...
  'usage', 'use', 'used', 'useful', 'useless', 'user', 'utility', 'vacant',
...
export const BIP39_WORD_COUNT = BIP39_ENGLISH_WORDLIST.length;
